# 1 "../MECH2200 SDP Lab 1 software/SPI.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../MECH2200 SDP Lab 1 software/SPI.c" 2
...
# 8 "../MECH2200 SDP Lab 1 software/SPI.c" 2
...
# 9 "../MECH2200 SDP Lab 1 software/SPI.c" 2
...
# 10 "../MECH2200 SDP Lab 1 software/SPI.c" 2
...
# 11 "../MECH2200 SDP Lab 1 software/SPI.c" 2
...
void MotorOn (void)
{
    ...
    SPIValue = SPIValue | 0b0000000000000001;
    WriteSPI(SPIAddress,SPIValue);
}
...
void MotorOff (void)
{
    ...
    SPIValue = SPIValue & 0b1111111111111110;
    WriteSPI(SPIAddress,SPIValue);
}
...
void LoadTorque (unsigned int TorqueValue)
{
    ...
    SPIValue = SPIValue & 0b1111111100000000;
...
void SetDRV8711_Mode(unsigned int Mode)
{
    ...
    SPIValue = SPIValue & 0b0000000011111111;

    switch(Mode)
    {
        case 0:
            SPIValue = SPIValue | 0b0000000000000000;
            break;

        case 1:
            SPIValue = SPIValue | 0b0000000100000000;
            break;
