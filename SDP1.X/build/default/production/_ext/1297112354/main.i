# 1 "../MECH2200 SDP Lab 1 software/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../MECH2200 SDP Lab 1 software/main.c" 2
...
# 11 "../MECH2200 SDP Lab 1 software/main.c" 2

# 1 "../MECH2200 SDP Lab 1 software/ADC.h" 1
# 22 "../MECH2200 SDP Lab 1 software/ADC.h"
...
# 12 "../MECH2200 SDP Lab 1 software/main.c" 2

# 1 "../MECH2200 SDP Lab 1 software/DAC.h" 1
# 20 "../MECH2200 SDP Lab 1 software/DAC.h"
void InitialiseDAC(void);
void LoadDAC_1(unsigned int);
void LoadDAC_2(unsigned int);
# 13 "../MECH2200 SDP Lab 1 software/main.c" 2
...
# 14 "../MECH2200 SDP Lab 1 software/main.c" 2

# 1 "../MECH2200 SDP Lab 1 software/SPI.h" 1
# 119 "../MECH2200 SDP Lab 1 software/SPI.h"
...
# 15 "../MECH2200 SDP Lab 1 software/main.c" 2
...
# 16 "../MECH2200 SDP Lab 1 software/main.c" 2
# 50 "../MECH2200 SDP Lab 1 software/main.c"
...
volatile unsigned char GLOBAL_ResultString[30];
volatile unsigned char GLOBAL_RxString[30];
    ...
    while(Status == 0)
    {
        ...
        else
        {
            ...
            else if(Value < 1000)
            {
                ...
                DisplayStringError(0xFFFA);
            }
            else if(Value > 2000)
            {


                DisplayStringError(0xFFFB);
            }
            else
            {
...
# 410 "../MECH2200 SDP Lab 1 software/main.c"
