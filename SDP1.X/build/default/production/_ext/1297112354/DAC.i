# 1 "../MECH2200 SDP Lab 1 software/DAC.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../MECH2200 SDP Lab 1 software/DAC.c" 2
...
# 13 "../MECH2200 SDP Lab 1 software/DAC.h"
...
# 13 "../MECH2200 SDP Lab 1 software/DAC.h" 2
...
# 8 "../MECH2200 SDP Lab 1 software/DAC.c" 2
...
void InitialiseDAC(void)
{
    ...
    DAC1CON0bits.DACFM = 0b0;
    DAC1CON0bits.DACPSS = 0b00;
    DAC1CON0bits.DACNSS = 0b00;
    ...
    OPA1PCHSbits.PCH = 0b0010;
    OPA1CONbits.UG = 0b1;
    OPA1CONbits.ORM = 0b00;
    OPA1CONbits.EN = 0b1;


    DAC1CON0bits.DACEN = 0b1;



    DAC2CON0bits.DACFM = 0b0;
    DAC2CON0bits.DACPSS = 0b00;
    DAC2CON0bits.DACNSS = 0b00;
    ...
    OPA2PCHSbits.PCH = 0b0011;
    OPA2CONbits.UG = 0b1;
    OPA2CONbits.ORM = 0b00;
    OPA2CONbits.EN = 0b1;


    DAC2CON0bits.DACEN = 0b1;
}
