# 1 "../MECH2200 SDP Lab 1 software/PWM.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../MECH2200 SDP Lab 1 software/PWM.c" 2
...
# 8 "../MECH2200 SDP Lab 1 software/PWM.c" 2
...
# 9 "../MECH2200 SDP Lab 1 software/PWM.c" 2
...
void InitialisePWM_16Bit(void)
{
    ...
    PWM5CON = 0x00;
    PWM5OFCONbits.OFM = 0b00;
    PWM5CLKCONbits.CS = 0b00;
    PWM5CLKCONbits.PS = 0b101;
    PWM5OF = 0x0000;
    PWM5PH = 0x0000;
    PWM5PR = 19999;
    PWM5TMR = 0;
    ...
    PWM6CON = 0x00;
    PWM6OFCONbits.OFM = 0b00;
    PWM6CLKCONbits.CS = 0b00;
    PWM6CLKCONbits.PS = 0b101;
    PWM6OF = 0x0000;
    PWM6PH = 0x0000;
    PWM6PR = 19999;
    PWM6TMR = 0;
